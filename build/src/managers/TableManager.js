...
var TableManager = (function () {
    ...
    TableManager.prototype.getByFilter = function () {
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                ...
                                this.tableService.queryEntities('customerdata', query, null, function (error, results, response) {
                                    if (!error) {
                                        // query was successful
                                    }
                                    resolve(results.entries.map(function (entrie) {
                                        return entrie.Name["_"];
                                    }).sort(function (a, b) {
